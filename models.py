...
def ctc_lambda_func(args):
    ...
    return K.ctc_batch_cost(ilabels, iy_pred, (iinput_length-2), ilabel_length)
...
def CRNN_STN(cfg):
    ...
    # stn = SpatialTransformer(localization_net=loc_net(loc_input_shape), output_size=(loc_input_shape[0], loc_input_shape[1]),  name='sp_trans')(bn_7)
    ...
    do_11 = Dropout(dropout_rate, name='dropout')(fc_9)
    fc_12 = Dense(cfg["ncharacters"], kernel_initializer='he_normal', activation='softmax', name='fc_12')(do_11)
...
#     reshape = Reshape(target_shape=(int(bn_7.shape[1]), int(bn_7_shape[2] * bn_7_shape[3])), name='reshape')(bn_7)
